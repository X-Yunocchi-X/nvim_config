return function()
	...
	vim.api.nvim_set_hl(0, "AlphaHeader", { fg = "#7FBBB3", default = true })
	vim.api.nvim_set_hl(0, "AlphaButtons", { fg = "#83C092", default = true })
	vim.api.nvim_set_hl(0, "AlphaShortcut", { fg = "#D699B6", italic = true, default = true })
	vim.api.nvim_set_hl(0, "AlphaFooter", { fg = "#DBBC7F", default = true })
